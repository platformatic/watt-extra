...
// Profiling errors
const ProfilingRuntimeNotAvailableError = createError('PLT_PROFILING_RUNTIME_NOT_AVAILABLE_ERROR', 'Runtime not available, cannot toggle profiling')
const ProfilingStatesSendError = createError('PLT_PROFILING_STATES_SEND_ERROR', 'Failed to send profiling states: %s')
...
export {
  ...
  StatusSendError,
  StatusAppIdError,
  ProfilingRuntimeNotAvailableError,
  ProfilingStatesSendError
}
